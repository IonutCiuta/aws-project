...
public class Properties {
    ...
    public static final Property name =
            ResourceFactory.createProperty(URLs.OD_URL, PROPERTY_NAME);

    public static final Property inCounty =
            ResourceFactory.createProperty(URLs.LOCATION_URL, PROPERTY_IN_COUNTY);

    public static final Property cui =
            ResourceFactory.createProperty(URLs.COMPANY_URL, PROPERTY_CUI);

    public static final Property locatedIn =
            ResourceFactory.createProperty(URLs.COMPANY_URL, PROPERTY_LOCATED_IN);

    public static final Property hasStatus =
            ResourceFactory.createProperty(URLs.COMPANY_URL, PROPERTY_HAS_STATUS);

    public static final Property shortName =
            ResourceFactory.createProperty(URLs.PARTY_URL, PROPERTY_SHORT_NAME);

    public static final Property year =
            ResourceFactory.createProperty(URLs.ELECTION_URL, PROPERTY_YEAR);

    public static final Property location =
            ResourceFactory.createProperty(URLs.OD_URL, PROPERTY_LOCATION);

    public static final Property forParty =
            ResourceFactory.createProperty(URLs.ELECTION_RESULT_URL, PROPERTY_FOR_PARTY);

    public static final Property totalVotes =
            ResourceFactory.createProperty(URLs.ELECTION_RESULT_URL, PROPERTY_TOTAL_VOTES);

    public static final Property ofElection =
            ResourceFactory.createProperty(URLs.ELECTION_RESULT_URL, PROPERTY_OF_ELECTION);
}
